...
@load "Data/fw-calibration/parameters-jse-weekly.jld2" optParam_FW_JSE_Weekly
...
@load "Data/fw-calibration/parameters-sse50-daily.jld2" optParam_FW_SSE50_Daily
...
@load "Data/fw-calibration/parameters-sse50-weekly.jld2" optParam_FW_SSE50_Weekly
...
@load "Data/fw-calibration/parameters-bsesn-daily.jld2" optParam_FW_BSESN_Daily
...
@load "Data/fw-calibration/parameters-bsesn-weekly.jld2" optParam_FW_BSESN_Weekly
...
function descriptiveStatistics(Returns, bt, et, indexReturns)
    ...
    descStat = Table(Asset = ["FW ABM", "Index", "Difference"], 
