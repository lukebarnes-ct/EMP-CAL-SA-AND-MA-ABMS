...
stockMinValues = [-20, -10, -5, -2, -1]
stockMaxValues = [2, 5, 10, 20]

for a in stockMaxValues

    println("STOCK MAXIMUM: ", a)

    for b in stockMinValues
...
### Initial Wealth Loops

InWealth = [10, 20, 30, 50, 100]

for a in InWealth

    println("Inital Wealth: ", a)
        ...
        function plotPrices(Prices, FValue, bt, et, kF, kC)
            ...
            elseif n == 3
                ...
                p3 = plot(t, Prices[3, t], label = "Price", title = "Asset 3, FMult = $a, CMult = $multiplerChart", 
                        xlabel = "T", ylabel = "Price", legend = :topleft)
...
### Initial Expected Return Chartists Loops

exp_IN = -0.015:0.005:0.025

for a in exp_IN

    println("Initial Chartist Expected Return: ", a)
        ...
        demFund, demChart, excDem = modelHyperparameters(timeEnd, n, numChart, numFund, 
                                                        ...
                                                        corrMax, corrMin, pWMax, pWMin, 
                                                        stockMax, stockMin, fundamental_value,
                                                        multiplierFund, multiplerChart, a)
...
InWealth = 2.8:0.1:4.2

for a in InWealth

    println("Inital Wealth Factor Fundamentalists: ", a)
...
for a in maxWind
    ...
    println("Inital Wealth Factor Fundamentalists: ", a)
        ...
        wInvFund, wInvFund_rf, wInvChart, wInvChart_rf, wFund, wChart, 
        demFund, demChart, excDem = modelHyperparameters(timeEnd, n, numChart, numFund, 
                                                        wMax_Fund, wMin_Fund, a, b, 
                                                        mRMax, mRMin, 
                                                        corrMax, corrMin, pWMax, pWMin, 
                                                        stockMax, stockMin, fundamental_value,
                                                        multiplierFund, multiplerChart, 
                                                        inExp_Chart, wealthFactor)
        ...
        function plotPrices(Prices, FValue, bt, et, kF, kC)
            ...
            elseif n == 3
                ...
                p1 = plot(t, Prices[1, t], label = "Price", title = "Asset 1, 
                      ...
                      EMA_Chart = [$wMin_Chart, $wMax_Chart], ForLoop = $a", 
                      xlabel = "T", ylabel = "Price", legend = :topleft)
